...
modapi = Blueprint('routes', __name__)
...
@modapi.route('/v1.0/aluno/<int:aluno_id>', methods=['PUT', 'DELETE', 'GET'])
...
@modapi.route('/v1.0/respostas/', methods=['GET'])
def respostas():
    if request.method == 'GET':
        cur = mysql.connection.cursor()
...
@modapi.route('/v1.0/resposta/<int:pergunta_id>/<int:aluno_id>',  methods=['POST'])
...
@modapi.route('/v1.0/resposta/<int:resposta_id>', methods=['PUT', 'DELETE', 'GET'])
...
@modapi.route('/v1.0/perguntas/', methods=['POST', 'GET'])
def perguntas():
...
@modapi.route('/v1.0/perguntas/<int:pergunta_id>', methods=['PUT', 'DELETE', 'GET'])
...
@modapi.route('/v1.0/resultados/', methods=['GET'])
def resultados():
...
@modapi.route('/v1.0/resultado/<int:resultado_id>', methods=['GET'])
...
@modapi.route('/v1.0/about')
def about():
    return render_template('about.html')

@modapi.errorhandler(404)
